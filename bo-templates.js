...
window.BO_TEMPLATE_LIBRARY = Object.freeze({
  ...
  'Acidente ou colisão com veículo': {
    ...
    questions:[
      {id:'tipoAcidente',label:'Tipo de ocorrência viária',type:'select',required:true,options:['Colisão entre veículos','Choque contra objeto/estrutura','Atropelamento','Tombamento/capotamento','Queda de carga com impacto viário','Outro']},
  ...
  'Estacionamento ou circulação irregular': {
    ...
    guidance:'Registre a irregularidade viária, a localização, a orientação realizada e o resultado.',
    questions:[
      {id:'tipoIrregularidade',label:'Tipo de irregularidade',type:'select',required:true,options:['Estacionamento em local proibido','Bloqueio de acesso/rota','Circulação em sentido/rota indevida','Velocidade/conduta incompatível observada','Parada em área operacional','Outra irregularidade']},
  ...
  'Avaria em peças, equipamentos ou vasilhames': {
    entities:{people:'required',witnesses:'recommended',vehicles:'recommended',materials:'required'}, evidence:'required',
  ...
  'Divergência de carga, quantidade ou documentação': {
    ...
    questions:[
      ...
      {id:'documento',label:'Documento de referência',type:'text',required:true,placeholder:'MVM, NF, romaneio ou outro documento.'},
  ...
  'Furto de material em área interna': {
    entities:{people:'required',witnesses:'recommended',vehicles:'recommended',materials:'required'}, evidence:'recommended',
    ...
    questions:[
      {id:'constatacao',label:'Como a ausência/subtração foi percebida?',type:'textarea',required:true},
      ...
      {id:'indicios',label:'Foram encontrados indícios materiais da subtração?',type:'select',required:true,options:['Não','Sim','Não foi possível confirmar']},
  ...
  'Furto de material em área externa': {
    ...
    questions:[
      ...
      {id:'indicios',label:'Foram encontrados indícios da subtração?',type:'select',required:true,options:['Não','Sim','Não foi possível confirmar']},
  ...
  'Desaparecimento de material ou equipamento': {
    entities:{people:'required',witnesses:'recommended',vehicles:'recommended',materials:'required'}, evidence:'recommended',
    guidance:'Não trate automaticamente como furto. Registre último paradeiro, movimentações conhecidas, buscas e eventual existência de indícios de subtração.',
    questions:[
      ...
      {id:'indiciosSubtracao',label:'Há indícios concretos de subtração?',type:'select',required:true,options:['Não identificados','Sim','Não foi possível concluir']},
  ...
  'Material ou equipamento encontrado/recolhido': {
    entities:{people:'required',witnesses:'hidden',vehicles:'recommended',materials:'required'}, evidence:'recommended',
  ...
  'Sintomas de embriaguez ou alteração de comportamento': {
    entities:{people:'required',witnesses:'recommended',vehicles:'recommended',materials:'hidden'}, evidence:'recommended',
    guidance:'Não diagnostique embriaguez. Registre sinais observáveis, comunicação, medidas preventivas e encaminhamento.',
    questions:[
      {id:'sinaisObservados',label:'Quais sinais comportamentais/físicos foram observados?',type:'textarea',required:true,placeholder:'Ex.: fala arrastada, dificuldade de equilíbrio, odor etílico, agitação. Não concluir diagnóstico.'},
  ...
  'Dano em instalação, equipamento ou patrimônio': {
    entities:{people:'required',witnesses:'recommended',vehicles:'recommended',materials:'recommended'}, evidence:'required',
    ...
    questions:[
      ...
      {id:'tipoDano',label:'Tipo de dano aparente',type:'text',required:true},
  ...
  'Auditoria ou descumprimento de processo': {
    entities:{people:'required',witnesses:'hidden',vehicles:'recommended',materials:'recommended'}, evidence:'recommended',
    guidance:'Registre processo/requisito, evidência observada, divergência, impacto e encaminhamento, sem atribuir culpa individual.',
    questions:[
  ...
  'Ato doloso, dano intencional ou sabotagem': {
    entities:{people:'required',witnesses:'recommended',vehicles:'recommended',materials:'recommended'}, evidence:'required',
    guidance:'Preserve fatos e evidências. Não afirme autoria ou intenção sem base; registre indícios, dano, acesso ao local e medidas de preservação.',
    questions:[
      ...
      {id:'indicios',label:'Quais indícios verificáveis sugerem ação intencional?',type:'textarea',required:true},
      {id:'autoria',label:'Há autoria identificada?',type:'select',required:true,options:['Não','Sim, identificada por evidência','Pessoa suspeita apenas por relato','Não foi possível confirmar']},
  ...
  'Atividade de segurança — outra situação': {
    ...
    guidance:'Registre a atividade de segurança, o fato constatado, risco, providência e condição final.',
    questions:[
      {id:'atividade',label:'Atividade de segurança em execução',type:'text',required:true},
      {id:'constatacao',label:'Fato constatado',type:'textarea',required:true},
      {id:'risco',label:'Risco identificado',type:'textarea',recommended:true},
      {id:'providencia',label:'Providência/acionamento realizado',type:'textarea',required:true},
      {id:'resultado',label:'Resultado/condição final',type:'textarea',required:true}
    ]
  },

  'Irregularidade não classificada': {
    entities:{people:'recommended',witnesses:'recommended',vehicles:'recommended',materials:'recommended'}, evidence:'recommended',
    guidance:'Use somente quando nenhuma referência específica representar o fato. Registre situação, elementos envolvidos, risco e providência.',
    questions:[
      {id:'situacao',label:'Descreva objetivamente a irregularidade',type:'textarea',required:true},
  ...
  'Outra ocorrência': {
    entities:{people:'recommended',witnesses:'recommended',vehicles:'recommended',materials:'recommended'}, evidence:'recommended',
    guidance:'Descreva a natureza do fato e registre somente os elementos realmente relacionados.',
    questions:[
      {id:'natureza',label:'Natureza da ocorrência não listada',type:'text',required:true},
