...
const OTHER_REFERENCE = 'Outra ocorrência';

const REFERENCE_DESCRIPTIONS = {
  'Acesso não autorizado': 'Use quando houver tentativa ou realização de entrada ou saída sem autorização válida.',
  ...
  'Entrada ou saída fora do horário autorizado': 'Use quando o acesso ocorrer ou for tentado fora da faixa de horário permitida.',
  'Pessoa ou veículo em área restrita': 'Use para permanência ou circulação em local sem permissão.',
  'Controle de acesso — outra situação': 'Use para outra ocorrência relacionada a portaria, entrada, saída ou credenciamento.',

  'Acidente ou colisão com veículo': 'Use para colisão, abalroamento, atropelamento, choque, capotamento ou outro acidente de trânsito interno.',
  'Avaria em veículo': 'Use para dano identificado em automóvel, caminhão, carreta, equipamento móvel ou veículo industrial.',
  'Entrada de veículo com danos': 'Use quando o veículo chega à unidade com avaria já existente.',
  'Estacionamento ou circulação irregular': 'Use para parada, vaga, rota, manobra ou circulação fora do procedimento.',
  'Remoção ou transporte por reboque': 'Use para remoção, transporte ou liberação de veículo por reboque.',
  'Veículo suspeito ou não identificado': 'Use quando houver veículo sem identificação suficiente ou com comportamento suspeito.',
  'Veículos e circulação — outra situação': 'Use para outra ocorrência relacionada a veículos ou tráfego interno.',

  'Avaria em peças, equipamentos ou vasilhames': 'Use para dano em peça, embalagem, equipamento, volume ou vasilhame.',
  ...
  'Furto de material em área interna': 'Use para subtração ou indício de furto dentro da unidade.',
  'Furto de material em área externa': 'Use para subtração ou indício de furto em área externa vinculada à unidade.',
  'Desaparecimento de material ou equipamento': 'Use quando um item não for localizado e ainda não houver confirmação de furto.',
  'Material ou equipamento encontrado/recolhido': 'Use para item localizado, recolhido, entregue ou mantido sob guarda da segurança.',
  'Liberação ou conferência de carga': 'Use para acompanhamento, conferência, transporte, entrada ou saída de materiais.',
  'Materiais, peças e cargas — outra situação': 'Use para outra ocorrência relacionada a material, peça, equipamento ou carga.',

  'Agressão física': 'Use para agressão, tentativa de agressão ou contato físico intencional entre pessoas.',
  'Ameaça, ofensa ou conflito': 'Use para ameaça, ofensa verbal, constrangimento, discussão ou conflito interpessoal.',
  'Descumprimento de norma ou transgressão disciplinar': 'Use para conduta incompatível com norma, procedimento ou orientação interna.',
  'Sintomas de embriaguez ou alteração de comportamento': 'Use quando houver sinais compatíveis com álcool, drogas ou alteração relevante de comportamento.',
  'Ocorrência médica, mal-estar ou acidente pessoal': 'Use para atendimento médico, mal-estar, lesão ou acidente envolvendo pessoa.',
  'Pessoas e conduta — outra situação': 'Use para outra ocorrência diretamente relacionada a comportamento ou condição de pessoa.',
  ...
  'Emergência operacional': 'Use para situação urgente que exija resposta imediata e controle do local.',
  'Falha ou erro operacional com impacto': 'Use quando uma falha de execução causar ou puder causar dano, risco ou interrupção.',
  'Ocorrência ambiental, vazamento ou derramamento': 'Use para vazamento, derramamento, emissão, descarte irregular ou risco ambiental.',
  'Instalações e emergências — outra situação': 'Use para outra ocorrência envolvendo patrimônio, instalação ou emergência.',

  'Fato identificado em ronda interna': 'Use para constatação realizada durante ronda dentro da unidade.',
  'Fato identificado em ronda externa': 'Use para constatação realizada durante ronda no perímetro ou área externa.',
  'Fiscalização ou inspeção de segurança': 'Use para irregularidade ou constatação encontrada em fiscalização ou inspeção.',
  'Auditoria ou descumprimento de processo': 'Use para constatação de auditoria, procedimento não seguido ou controle de processo.',
  'Ato doloso, dano intencional ou sabotagem': 'Use quando houver indício de ação deliberada para causar dano, prejuízo ou interrupção.',
  'Ocorrência envolvendo empresa prestadora de segurança': 'Use para fato relacionado à equipe ou empresa terceirizada de segurança.',
  'Atividade de segurança — outra situação': 'Use para outra ocorrência identificada em atividade operacional da segurança.',

  'Irregularidade não classificada': 'Use quando o fato for irregular, mas ainda não se encaixar em uma categoria específica.',
  [OTHER_REFERENCE]: 'Use somente quando nenhuma opção da lista representar adequadamente o fato. Descreva o assunto principal.'
};
...
const POPULAR_REFERENCES = [
  ...
  'Avaria em peças, equipamentos ou vasilhames',
  'Desaparecimento de material ou equipamento',
  'Fato identificado em ronda interna'
];
...
const REFERENCE_GROUPS = [
  {
    ...
    options: [
      ...
      'Entrada ou saída fora do horário autorizado',
      'Pessoa ou veículo em área restrita',
      'Controle de acesso — outra situação'
    ]
  },
  {
    ...
    options: [
      ...
      'Avaria em veículo',
      'Entrada de veículo com danos',
      'Estacionamento ou circulação irregular',
      'Remoção ou transporte por reboque',
      'Veículo suspeito ou não identificado',
      'Veículos e circulação — outra situação'
    ]
  },
  {
    ...
    options: [
      ...
      'Furto de material em área interna',
      'Furto de material em área externa',
      'Desaparecimento de material ou equipamento',
      'Material ou equipamento encontrado/recolhido',
      'Liberação ou conferência de carga',
      'Materiais, peças e cargas — outra situação'
    ]
  },
  {
    label: 'Pessoas, conduta e saúde',
    options: [
      'Agressão física',
      'Ameaça, ofensa ou conflito',
      'Descumprimento de norma ou transgressão disciplinar',
      'Sintomas de embriaguez ou alteração de comportamento',
      'Ocorrência médica, mal-estar ou acidente pessoal',
      'Pessoas e conduta — outra situação'
    ]
  },
  {
    ...
    options: [
      ...
      'Falha ou erro operacional com impacto',
      'Ocorrência ambiental, vazamento ou derramamento',
      'Instalações e emergências — outra situação'
    ]
  },
  {
    label: 'Atividade de segurança e controle',
    options: [
      'Fato identificado em ronda interna',
      'Fato identificado em ronda externa',
      'Fiscalização ou inspeção de segurança',
      'Auditoria ou descumprimento de processo',
      'Ato doloso, dano intencional ou sabotagem',
      'Ocorrência envolvendo empresa prestadora de segurança',
      'Atividade de segurança — outra situação'
    ]
  },
  {
    label: 'Outras ocorrências',
    options: ['Irregularidade não classificada', OTHER_REFERENCE]
  }
];
const REFERENCES = REFERENCE_GROUPS.flatMap(group => group.options);

const LEGACY_REFERENCE_MAP = Object.freeze({
  'Acesso': 'Controle de acesso — outra situação',
  'Ato doloso': 'Ato doloso, dano intencional ou sabotagem',
  'Auditoria de processos': 'Auditoria ou descumprimento de processo',
  'Carga de materiais': 'Liberação ou conferência de carga',
  'Emergência': 'Emergência operacional',
  'Fiscalização': 'Fiscalização ou inspeção de segurança',
  'Irregularidade': 'Irregularidade não classificada',
  'Ocorrência médica': 'Ocorrência médica, mal-estar ou acidente pessoal',
  'Ronda (interna / externa)': 'Fato identificado em ronda interna',
  'Sintomas de embriaguez': 'Sintomas de embriaguez ou alteração de comportamento',
  'Transgressão disciplinar': 'Descumprimento de norma ou transgressão disciplinar',
  'Veículos': 'Veículos e circulação — outra situação',
  'Souza Lima': 'Ocorrência envolvendo empresa prestadora de segurança',
  'Danos materiais — Agressão física': 'Agressão física',
  'Danos materiais — Avaria em peças / vasilhames': 'Avaria em peças, equipamentos ou vasilhames',
  'Danos materiais — Danos às instalações industriais': 'Dano em instalação, equipamento ou patrimônio',
  'Danos materiais — Entrada com danos': 'Entrada de veículo com danos',
  'Danos materiais — Erro operacional': 'Falha ou erro operacional com impacto',
  'Danos materiais — Faixa horária inválida': 'Entrada ou saída fora do horário autorizado',
  'Danos materiais — Furto em área externa': 'Furto de material em área externa',
  'Danos materiais — Furto em área interna': 'Furto de material em área interna',
  'Danos materiais — Incêndio': 'Incêndio ou princípio de incêndio',
  'Danos materiais — Ofensa moral': 'Ameaça, ofensa ou conflito',
  'Danos materiais — Queixa de desaparecimento de material / equipamento': 'Desaparecimento de material ou equipamento',
  'Danos materiais — Recolhimento de material / equipamento': 'Material ou equipamento encontrado/recolhido',
  'Danos materiais — Transporte por reboque': 'Remoção ou transporte por reboque',
...
function referenceFlow(reference = '') {
  ...
  return {
    ...
    materials: /(material|peca|vasilhame|carga|equipamento|mvm|nota fiscal|furto|desaparecimento|recolhido)/.test(value),
    attachments: /(dano|avaria|furto|incendio|irregularidade|veiculo|agressao|ameaca|ato doloso|vazamento|derramamento|acidente)/.test(value),
    medical: /(medic|mal-estar|acidente pessoal|embriaguez|agressao)/.test(value)
  };
}
...
function templateEntityMode(key, record = state.current) {
  return templateFor(record?.basic?.referencia).entities?.[key] || 'recommended';
}

function templateQuestionList(record = state.current) {
  const template = templateFor(record?.basic?.referencia);
  const answers = record?.templateData?.answers || {};
  return (template.questions || []).filter(question => {
    if (!question.when) return true;
    const current = answers[question.when.id];
    if ('equals' in question.when) return current === question.when.equals;
    if (Array.isArray(question.when.in)) return question.when.in.includes(current);
    return true;
  });
}
  ...
  templateQuestionList(record).forEach(question => {
    ...
    if (!templateAnswerAvailable(templateAnswer(record, question.id))) {
      issues.push({
        ...
        key:'template',
        title:'Informação essencial do modelo',
        message:`Informe: ${question.label}`
      });
    }
  });
  return issues;
...
function templateCompleteness(record = state.current) {
  const required = templateQuestionList(record).filter(question => question.required);
  const recommended = templateQuestionList(record).filter(question => question.recommended);
...
function syncTemplateVerification(record = state.current) {
  ...
  ['people','witnesses','vehicles','materials'].forEach(key => {
    const mode = template.entities?.[key] || 'recommended';
    if (mode === 'hidden') record.verification[key] = 'none';
    else if (key === 'witnesses' && record.people?.some(person => person.tipo === 'Testemunha')) record.verification[key] = 'has';
    else {
      const collection = key === 'people' ? (record.people || []).filter(person => person.tipo !== 'Testemunha') : key === 'vehicles' ? record.vehicles : key === 'materials' ? record.materials : [];
      if (collection?.length) record.verification[key] = 'has';
      else if (record.verification[key] === 'none') record.verification[key] = 'none';
      else record.verification[key] = 'pending';
    }
  });
}

function requesterCountsAsInvolved(record = state.current) {
  return record?.templateData?.requesterRole === 'Envolvido diretamente';
}
...
function assistantContext(record = state.current) {
  ...
  const material = /(material|peca|vasilhame|carga|equipamento|recolhimento|desaparecimento|furto)/.test(searchable) || Boolean(record?.materials?.length);
  ...
  const medical = /(medic|embriaguez|agressao fisica)/.test(searchable);
  const theft = /(furto|desaparecimento|subtracao)/.test(searchable);
  const damage = /(dano|avaria|falha operacional|ato doloso|patrimonio|sabotagem)/.test(searchable);

  let profile = 'Ocorrência geral';
  if (environmental) profile = 'Ocorrência ambiental';
  else if (fire) profile = 'Emergência ou incêndio';
  else if (medical) profile = 'Ocorrência médica ou envolvendo pessoa';
  else if (theft) profile = 'Furto ou desaparecimento';
  ...
  const vehicleRequired = accident || /(avaria em veiculo|entrada de veiculo com danos|reboque|estacionamento|circulacao irregular|veiculo suspeito)/.test(searchable);
  const materialRequired = theft || /(carga|avaria em pecas|vasilhame|material ou equipamento encontrado|desaparecimento de material|divergencia de carga)/.test(searchable);
...
function assistantChecklist(record = state.current) {
  ...
  add('bo-name','Solicitante identificado',meaningfulText(b.nomeEmissor) && /^\d+$/.test(b.matriculaEmissor||''),'required',0,'Informe nome e matrícula do solicitante.');
  add('bo-directorate','Diretoria relacionada',meaningfulText(b.diretoria),'required',0,'Informe a diretoria relacionada.');

  const modes = template.entities || {};
  if ((modes.people||'recommended') !== 'hidden') {
    add('requester-role','Relação do solicitante',meaningfulText(r.templateData?.requesterRole),'required',1,'Informe se o solicitante também é envolvido.','people');
    add('','Pessoas verificadas',v.people !== 'pending','required',1,'Confirme se existem outras pessoas envolvidas.','people');
    const personsOk = requesterCountsAsInvolved(r) || (r.people||[]).some(p=>p.tipo!=='Testemunha');
    if (modes.people === 'required') add('','Pessoa diretamente envolvida identificada',personsOk,'required',1,'Cadastre a pessoa envolvida ou indique que o solicitante é o próprio envolvido.','people');
  }
  if ((modes.witnesses||'recommended') !== 'hidden') add('','Testemunhas verificadas',v.witnesses !== 'pending','required',1,'Confirme se há testemunhas.','witnesses');
  if ((modes.vehicles||'recommended') !== 'hidden') {
    add('','Veículos verificados',v.vehicles !== 'pending','required',1,'Confirme se há veículo relacionado.','vehicles');
    if (modes.vehicles === 'required') add('','Veículo principal cadastrado',(r.vehicles||[]).length>0,'required',1,'Cadastre o veículo relacionado.','vehicles');
    else if (modes.vehicles === 'recommended') add('','Dados de veículo, quando aplicável',(r.vehicles||[]).length>0 || v.vehicles==='none','recommended',1,'Cadastre o veículo caso esteja relacionado.','vehicles');
  }
  if ((modes.materials||'recommended') !== 'hidden') {
    add('','Materiais verificados',v.materials !== 'pending','required',1,'Confirme se há material, peça, equipamento ou carga relacionado.','materials');
    if (modes.materials === 'required') add('','Material/carga principal cadastrado',(r.materials||[]).length>0,'required',1,'Cadastre o material, peça, equipamento ou carga.','materials');
  }

  add('history-start','Relato recebido',meaningfulText(h.inicio),'required',2,'Registre como o fato foi informado.');
  add('history-found','Constatação da Segurança',meaningfulText(h.identificado),'required',2,'Registre o que a equipe constatou no local.');
  ...
  add('history-actions','Providências verificadas',v.providencias !== 'pending','required',3,'Confirme se houve providências.','providencias');
  if (v.providencias === 'has') add('history-actions','Providências descritas',meaningfulText(h.providenciasFonte)||meaningfulText(h.providencias),'required',3,'Descreva as providências adotadas.','providencias');
  add('','Evidências verificadas',v.attachments !== 'pending','required',3,'Confirme se há fotos ou documentos.','attachments');
  if (template.evidence === 'required') {
    const evidenceOk = (r.attachments||[]).length>0 || (v.attachments==='none' && meaningfulText(r.templateData?.evidenceUnavailableReason));
    add('evidence-unavailable-reason','Evidência ou justificativa de indisponibilidade',evidenceOk,'required',3,'Inclua evidência ou justifique por que não foi possível registrá-la.','attachments');
  }
...
function assistantMissing(record = state.current, level = '') {
  return assistantChecklist(record).filter(item => !item.ok && (!level || item.level === level));
}
...
function assistantVehicleSummary(vehicle) {
  const details = [`placa ou chassi ${vehicle.placa || 'não informado'}`];
...
function assistantMaterialSummary(material) {
  const details = [material.denominacao || 'material sem denominação'];
  if (material.quantidade) details.push(`quantidade ${material.quantidade}${material.unidade ? ` ${material.unidade}` : ''}`);
  if (material.mvm) details.push(`MVM/NF ${material.mvm}`);
  if (material.fornecedor) details.push(`fornecedor ${material.fornecedor}`);
  if (material.desenho) details.push(`desenho ${material.desenho}`);
...
function buildAssistantProvidences(record = state.current) {
  ...
  if (record?.verification?.providencias === 'none') {
    return 'Não foi necessária providência adicional no momento do registro.';
  }
  ...
  if (called && !normalizeAssistantText(actions).includes(normalizeAssistantText(called))) parts.push(`Foram acionados: ${called}.`);
...
function buildNarrative(record = state.current) {
  ...
  const reference = meaningfulText(resolvedReference(b));
  const paragraphs = [];
  let introduction = `Em ${formatDateOnly(b.data)}, às ${b.hora}, durante atendimento da Segurança Patrimonial no local ${local || 'informado no boletim'}, foi registrado fato classificado como ${reference || 'ocorrência não classificada'}`;
  if (meaningfulText(b.nomeEmissor)) introduction += `, a partir de solicitação de ${b.nomeEmissor}${b.matriculaEmissor ? `, matrícula ${b.matriculaEmissor}` : ''}`;
  if (meaningfulText(b.diretoria)) introduction += `, relacionado à diretoria ${b.diretoria === 'Outra' ? b.diretoriaOutra : b.diretoria}${b.setorArea ? `, setor/área ${b.setorArea}` : ''}`;
  paragraphs.push(`${introduction}.`);

  const received = cleanSentence(h.inicio);
  if (received) paragraphs.push(`Segundo as informações coletadas no atendimento, ${received.charAt(0).toLocaleLowerCase('pt-BR')}${received.slice(1)}.`);
  const found = cleanSentence(h.identificado);
  if (found) paragraphs.push(`No local, a equipe de Segurança Patrimonial constatou que ${found.charAt(0).toLocaleLowerCase('pt-BR')}${found.slice(1)}.`);

  const structured = templateAnswerSummary(record);
  if (structured.length) {
    const details = structured.map(item => `${item.label.replace(/[?:]$/,'')}: ${item.value}`).join('; ');
    paragraphs.push(`Durante a apuração padronizada, foram registrados os seguintes elementos: ${details}.`);
  }

  if (requesterCountsAsInvolved(record)) paragraphs.push(`O solicitante foi identificado também como pessoa diretamente envolvida no fato.`);
  ...
  if (persons.length) paragraphs.push(`Pessoas relacionadas: ${joinNatural(persons.map(assistantPersonSummary))}.`);
  if (witnesses.length) paragraphs.push(`Testemunhas identificadas: ${joinNatural(witnesses.map(assistantPersonSummary))}.`);
  if ((record.vehicles || []).length) paragraphs.push(`Veículos relacionados: ${joinNatural(record.vehicles.map(assistantVehicleSummary))}.`);
  if ((record.materials || []).length) paragraphs.push(`Materiais, peças, equipamentos ou cargas relacionados: ${joinNatural(record.materials.map(assistantMaterialSummary))}.`);
  if (record.verification?.attachments === 'none' && meaningfulText(record.templateData?.evidenceUnavailableReason)) paragraphs.push(`Não foi possível registrar evidência fotográfica/documental pelo seguinte motivo: ${cleanSentence(record.templateData.evidenceUnavailableReason)}.`);

  const providences = meaningfulText(h.providencias) || buildAssistantProvidences(record);
  if (providences) paragraphs.push(providences.replace(/[.!?]+$/, '') + '.');
  const outcome = cleanSentence(h.desfecho);
  if (outcome) paragraphs.push(`Ao término do atendimento, ${outcome.charAt(0).toLocaleLowerCase('pt-BR')}${outcome.slice(1)}.`);
  const additional = cleanSentence(h.adicional);
  if (additional) paragraphs.push(`Como informação complementar, ${additional.charAt(0).toLocaleLowerCase('pt-BR')}${additional.slice(1)}.`);

  return paragraphs.map(paragraph=>paragraph.replace(/\s+/g,' ').replace(/\.\s*\./g,'.').trim()).filter(Boolean).join('\n\n');
}
...
function renderAssistantCard(record = state.current) {
  ...
  const requiredMissing = checks.filter(item => !item.ok && item.level === 'required').length;
  const recommendedMissing = checks.filter(item => !item.ok && item.level === 'recommended').length;
  const assistantState = record.assistant || {};
  const generationStatus = assistantState.generatedAt
    ? (assistantState.stale ? 'Dados alterados após a última geração' : `Texto atualizado em ${formatDateTime(assistantState.generatedAt)}`)
  ...
  return `<section class="assistant-card" aria-labelledby="assistant-title">
    <div class="assistant-header">
      <div class="assistant-avatar" aria-hidden="true">${ICONS.shield}</div>
...
function createBlankRecord() {
  ...
  return {
    ...
    basic: {
      data: localDateInput(now), hora: localTimeInput(now), categoria: '', referencia: '', referenciaOutra: '',
    ...
    templateData: { reference:'', requesterRole:'', evidenceUnavailableReason:'', answers:{} },
    history: {
      identificado: '', inicio: '', presentes: '', providenciasFonte: '', providencias: '',
      providenciasEditadas: false, acionados: '', desfecho: '', adicional: '',
      relato: '', relatoEditado: false, observacoes: ''
    },
    assistant: { generatedAt: '', profile: '', stale: false },
...
async function saveCurrent(silent = true, autoSync = true) {
  ...
  if (state.current.status === 'Finalizado') {
    ...
    else if (!['conflict','error'].includes(state.current.syncStatus)) state.current.syncStatus = 'pending';
  } else {
...
function normalizeRecord(record) {
  ...
  normalized.schemaVersion = Math.max(6, Number(normalized.schemaVersion || 4));
  normalized.basic ||= {};
...
function updateHeader() {
  ...
  const compactStatus = state.route === 'wizard' && info.status === 'local' ? 'Salvo' : info.label;
...
function basicReferenceFields(b) {
  ...
  const categoryMarks = {
    ...
    'Pessoas, conduta e saúde':'PS','Instalações, patrimônio e emergências':'IE',
    'Atividade de segurança e controle':'SC','Outras ocorrências':'OU'
  };
  return `
    <div class="field full occurrence-classifier">
      <label class="required">1. Natureza da ocorrência</label>
      <p class="field-intro">Escolha primeiro a área do fato. O aplicativo mostrará somente os boletins padronizados correspondentes.</p>
    ...
    ${selectedGroup ? `<div class="field full occurrence-type-block"><label class="required">2. Tipo de boletim</label><p class="field-intro">Selecione a situação que melhor representa o fato constatado.</p><div id="bo-ref" class="reference-choice-list">${selectedGroup.options.map(value => `<button type="button" class="reference-choice ${normalizeReference(b.referencia)===value?'active':''}" data-select-reference="${escapeHtml(value)}"><strong>${escapeHtml(value)}</strong><span>${escapeHtml(REFERENCE_DESCRIPTIONS[value]||'')}</span></button>`).join('')}</div><span class="field-error" data-error-for="bo-ref"></span></div>` : '<div class="notice subtle"><strong>Selecione a natureza da ocorrência</strong><span>Os tipos de BO aparecerão aqui.</span></div>'}
    ${b.referencia ? `<div class="template-guidance"><span class="template-guidance-mark">NX</span><div><strong>Roteiro deste boletim</strong><p>${escapeHtml(template.guidance || referenceDescription || 'O aplicativo orientará a coleta das informações essenciais.')}</p></div></div>` : ''}
...
function basicDirectorateFields(b) {
  ...
  return `
    <div class="field"><label class="required" for="bo-directorate">Diretoria relacionada</label><select id="bo-directorate" data-path="basic.diretoria" data-rerender="true" required>${selectOptions(DIRECTORATES, b.diretoria)}</select><span class="field-error" data-error-for="bo-directorate"></span></div>
...
function renderBasicStep() {
  ...
  return `
    ...
    <section class="form-card">
      <p class="eyebrow">1. Ocorrência</p>
      <h1>Identifique o fato</h1>
      <p>O boletim foi iniciado automaticamente com a chegada do vigilante. Classifique o fato e registre onde ocorreu e quem solicitou o atendimento.</p>
      <div class="form-grid">
    ...
    <section class="form-card compact-card">
      <p class="eyebrow">Solicitante</p><h2>Quem acionou a Segurança?</h2>
      <div class="form-grid">${basicRequesterFields(b)}${basicDirectorateFields(b)}</div>
    </section>
    <div class="notice info"><strong>Fluxo orientado:</strong> depois desta etapa, o aplicativo mostrará somente pessoas, veículos, materiais e perguntas relevantes para o tipo de BO escolhido.</div>`;
}
...
function renderRelatedStep() {
  const template = templateFor(state.current.basic.referencia);
  const modes = template.entities || {};
  const blocks = [];
  if ((modes.people || 'recommended') !== 'hidden') blocks.push(relatedSection('people',{verify:'people',title:'Pessoas envolvidas',description:'Cadastre envolvidos diretamente relacionados ao fato. O solicitante principal já foi identificado na etapa anterior.',button:'Adicionar pessoa',question:'Há outras pessoas diretamente envolvidas?',noneLabel:'Não há outra pessoa identificada',empty:'Nenhuma pessoa envolvida cadastrada.',render:renderPersonItem,filter:person=>person.tipo!=='Testemunha',recommended:modes.people==='recommended'}));
  if ((modes.vehicles || 'recommended') !== 'hidden') blocks.push(relatedSection('vehicles',{verify:'vehicles',title:'Veículos relacionados',description:'Identificação, empresa e vínculo com pessoas do boletim.',button:'Adicionar veículo',question:'Há veículo relacionado?',noneLabel:'Não há veículo relacionado',empty:'Nenhum veículo cadastrado.',render:renderVehicleItem,recommended:modes.vehicles==='recommended'}));
  if ((modes.materials || 'recommended') !== 'hidden') blocks.push(relatedSection('materials',{verify:'materials',title:'Materiais, peças, equipamentos ou cargas',description:'Cadastre somente itens diretamente ligados ao fato.',button:'Adicionar material',question:'Há material, peça, equipamento ou carga relacionado?',noneLabel:'Não há material relacionado',empty:'Nenhum material cadastrado.',render:renderMaterialItem,recommended:modes.materials==='recommended'}));
  const witnessMode = modes.witnesses || 'recommended';
  const witnessBlock = witnessMode === 'hidden' ? '' : `<section class="related-block witness-only ${witnessMode==='recommended'?'recommended':''}" data-correction-section="witnesses"><div class="entity-toolbar"><div><p class="eyebrow">${witnessMode==='required'?'Informação essencial':'Quando disponível'}</p><h2>Testemunhas</h2><p>Cadastre testemunhas somente quando puderem contribuir com fatos relevantes.</p></div><button class="button secondary small" type="button" data-add-witness>${ICONS.plus} Adicionar testemunha</button></div>${verificationChoice('witnesses','Existem testemunhas identificadas?',state.current.people.some(p=>p.tipo==='Testemunha'),'Não há testemunhas identificadas')}<div class="entity-list">${state.current.people.filter(p=>p.tipo==='Testemunha').length?state.current.people.map((p,i)=>({p,i})).filter(x=>x.p.tipo==='Testemunha').map(x=>renderPersonItem(x.p,x.i)).join(''):'<div class="entity-empty">Nenhuma testemunha cadastrada.</div>'}</div></section>`;
  return `<section class="form-card step-intro-card"><p class="eyebrow">2. Dados essenciais</p><h1>Registre somente o que é relevante</h1><p>O modelo <strong>${escapeHtml(resolvedReference(state.current.basic))}</strong> foi configurado para priorizar os cadastros abaixo. Itens sem relação com este tipo de ocorrência foram ocultados.</p><div class="template-guidance inline"><span class="template-guidance-mark">NX</span><div><strong>Orientação do modelo</strong><p>${escapeHtml(template.guidance || '')}</p></div></div></section>${(modes.people||'recommended')!=='hidden'?`<section class="form-card requester-role-card"><p class="eyebrow">Relação do solicitante</p><h2>${escapeHtml(state.current.basic.nomeEmissor || 'Solicitante')}</h2><div class="field full"><label class="required" for="requester-role">Qual é a relação do solicitante com o fato?</label><select id="requester-role" data-path="templateData.requesterRole" required>${selectOptions(['Envolvido diretamente','Apenas comunicou/solicitou o atendimento','Responsável pelo local/material/veículo','Não foi possível definir'],state.current.templateData?.requesterRole||'')}</select><small>Se o solicitante for o próprio envolvido, não é necessário cadastrá-lo novamente em Pessoas.</small><span class="field-error" data-error-for="requester-role"></span></div></section>`:''}<div class="related-grid">${blocks.join('')}${witnessBlock}</div>`;
}
...
function renderTemplateQuestion(question, record = state.current) {
  ...
  let control = '';
  if (question.type === 'select') control = `<select id="${id}" data-path="templateData.answers.${escapeHtml(question.id)}" ${required}>${selectOptions(question.options || [], value)}</select>`;
  ...
  return `<div class="field full template-question ${level}" data-template-question="${escapeHtml(question.id)}"><div class="template-question-label"><label class="${question.required?'required':''}" for="${id}">${escapeHtml(question.label)}</label><span class="question-level ${level}">${levelLabel}</span></div>${control}${question.help?`<small>${escapeHtml(question.help)}</small>`:''}<span class="field-error" data-error-for="${id}"></span>${unavailable}</div>`;
}

function renderTemplateInsight(record = state.current) {
  const reference = resolvedReference(record.basic);
  if (reference === 'Divergência de carga, quantidade ou documentação') {
    const expectedRaw = String(templateAnswer(record, 'quantidadePrevista') || '').replace(',', '.');
    const observedRaw = String(templateAnswer(record, 'quantidadeConstatada') || '').replace(',', '.');
    const expected = Number(expectedRaw);
    const observed = Number(observedRaw);
    if (expectedRaw && observedRaw && Number.isFinite(expected) && Number.isFinite(observed)) {
      const difference = observed - expected;
      const sign = difference > 0 ? '+' : '';
      const className = difference === 0 ? 'ok' : 'attention';
      const description = difference === 0
        ? 'As quantidades informadas coincidem. Confirme também identificação, documentação e lacre.'
        : `Diferença calculada: ${sign}${difference}. Registre no campo de descrição como essa divergência foi constatada.`;
      return `<div class="template-calculated-insight ${className}"><span>${difference === 0 ? ICONS.check : ICONS.warning}</span><div><strong>Conferência automática de quantidade</strong><p>Prevista: ${escapeHtml(expectedRaw)} • Constatada: ${escapeHtml(observedRaw)} • ${escapeHtml(description)}</p></div></div>`;
    }
  }
  return '';
}
...
function renderInvestigationStep() {
  ...
  const h = r.history;
  const template = templateFor(r.basic.referencia);
  const questions = templateQuestionList(r);
  const completeness = templateCompleteness(r);
  return `<section class="form-card step-intro-card"><p class="eyebrow">3. Apuração</p><h1>Apuração guiada: ${escapeHtml(resolvedReference(r.basic))}</h1><p>Registre primeiro o que foi <strong>informado</strong> e depois o que foi <strong>constatado pela Segurança</strong>. Em seguida, responda ao roteiro padronizado deste tipo de BO.</p></section>
  <section class="form-card fact-source-card"><div class="fact-source-grid"><div class="field full"><div class="fact-source-title"><span>1</span><div><strong>Relato recebido</strong><small>Informação de solicitante, envolvido ou terceiro</small></div></div><label class="required" for="history-start">Como o fato foi informado à equipe?</label><textarea id="history-start" data-path="history.inicio" placeholder="Ex.: Segundo relato do solicitante..." required>${escapeHtml(h.inicio)}</textarea><span class="field-error" data-error-for="history-start"></span></div><div class="field full"><div class="fact-source-title"><span>2</span><div><strong>Constatação da Segurança</strong><small>Somente fatos observados ou verificados</small></div></div><label class="required" for="history-found">O que a equipe constatou no local?</label><textarea id="history-found" data-path="history.identificado" placeholder="Ex.: No local, foi constatado..." required>${escapeHtml(h.identificado)}</textarea><span class="field-error" data-error-for="history-found"></span></div></div></section>
  <section class="form-card template-question-card"><div class="template-question-head"><div><p class="eyebrow">Roteiro padronizado</p><h2>Informações que não podem ser esquecidas</h2><p>${escapeHtml(template.guidance || '')}</p></div><div class="quality-mini ${completeness.complete?'complete':'pending'}"><strong>${completeness.required.length-completeness.requiredMissing.length}/${completeness.required.length}</strong><span>essenciais</span></div></div><div class="form-grid template-form-grid">${questions.map(q=>renderTemplateQuestion(q,r)).join('')}</div>${renderTemplateInsight(r)}${!questions.length?'<div class="entity-empty">Este modelo não possui perguntas adicionais.</div>':''}</section>
  <div class="notice subtle"><strong>Linguagem profissional:</strong><span>registre fatos observáveis. Quando uma informação não puder ser obtida, use “Não foi possível obter” e informe o motivo.</span></div>`;
}
...
function renderEvidenceBlock() {
  ...
  const evidenceRequired = template.evidence === 'required';
  const unavailableReason = String(state.current.templateData?.evidenceUnavailableReason || '');
  const reasonField = evidenceRequired && status === 'none'
    ? `<div class="field full evidence-reason-field"><label class="required" for="evidence-unavailable-reason">Justifique por que não foi possível registrar evidência</label><textarea id="evidence-unavailable-reason" data-path="templateData.evidenceUnavailableReason" placeholder="Ex.: local liberado antes da chegada da equipe; condição não permitia registro fotográfico..." required>${escapeHtml(unavailableReason)}</textarea><small>A justificativa deve descrever somente o motivo real da indisponibilidade.</small><span class="field-error" data-error-for="evidence-unavailable-reason"></span></div>`
    : '';
  return `<section class="evidence-inline-card"><div class="entity-toolbar"><div><p class="eyebrow">Evidências</p><h2>Fotos e documentos</h2><p>${evidenceRequired?'Para este tipo de BO, a evidência é considerada essencial quando tecnicamente possível.':'Inclua evidências quando contribuírem para comprovação ou compreensão do fato.'}</p></div><span class="question-level ${evidenceRequired?'required':'recommended'}">${evidenceRequired?'Essencial':'Recomendado'}</span></div>${verificationChoice('attachments','Há foto ou documento relacionado?',state.current.attachments.length>0,'Não foi possível registrar evidência')}${reasonField}<div class="attachment-actions"><button class="button primary" type="button" data-pick-file="camera">${ICONS.plus} Tirar foto</button><button class="button secondary" type="button" data-pick-file="gallery">Galeria</button><button class="button secondary" type="button" data-pick-file="document">Documento</button></div><input id="attachment-camera" class="hidden" type="file" accept="image/*" capture="environment"><input id="attachment-gallery" class="hidden" type="file" multiple accept="image/*"><input id="attachment-document" class="hidden" type="file" multiple accept=".pdf,.doc,.docx,.xls,.xlsx,text/plain"><div class="storage-meter"><span>${state.current.attachments.length} arquivo(s)</span><strong>${humanSize(size)} utilizados</strong></div><div class="file-grid">${state.current.attachments.map((file,index)=>renderFileItem(file,index)).join('')}</div>${status==='pending'?'<div class="notice warning compact">Confirme se há evidência ou informe que ela não pôde ser registrada.</div>':''}</section>`;
}
...
function renderActionsEvidenceStep() {
  ...
  ${renderEvidenceBlock()}
  <section class="form-card assistant-output-card compact-assistant-output"><div class="narrative-builder"><div><p class="eyebrow">NEXO • padronização local</p><h2>Relato profissional</h2><p>O texto é montado somente com dados preenchidos no BO, separando relato de terceiros, constatação e providências.</p></div><button class="button primary" type="button" data-action="assistant-generate">${ICONS.file} Gerar/atualizar relato</button></div><div class="field full"><label for="history-report">Prévia do relato consolidado</label><textarea id="history-report" data-path="history.relato" data-manual-narrative="true" placeholder="O relato será gerado automaticamente antes da revisão.">${escapeHtml(h.relato)}</textarea><small>Você pode ajustar a redação, sem inserir fatos não confirmados.</small></div></section>`;
}
...
function renderHistoryStep() {
  ...
  <section class="form-card assistant-output-card">
    ...
    <div class="field full"><label class="required" for="history-report">Relato consolidado</label><textarea id="history-report" data-path="history.relato" data-manual-narrative="true" placeholder="O assistente reunirá data, local, pessoas, veículos, materiais, MVM, desenho, quantidade e demais dados preenchidos." required>${escapeHtml(h.relato)}</textarea><small>Revise o texto antes de finalizar. Alterações manuais serão preservadas.</small><span class="field-error" data-error-for="history-report"></span></div>
  </section>`;
}
...
function reviewItems(record = state.current) {
  ...
  return [
    make('occurrence','Identificação da ocorrência',0,step0,'bo-ref','Classificação, local, solicitante e diretoria conferidos.'),
    make('essentials','Pessoas, veículos e materiais',1,step1,'requester-role','Elementos relevantes ao modelo foram verificados.'),
    make('investigation','Apuração padronizada',2,step2,'history-start','Relato recebido, constatação e roteiro específico concluídos.'),
    ...
    make('attachments','Evidências',3,step3.filter(i=>i.key==='attachments'),'','Fotos/documentos foram anexados ou a indisponibilidade foi confirmada.'),
...
function renderReviewStep() {
  const r = state.current;
  const b = r.basic;
  const reference = resolvedReference(b);
  ...
  const qualityLabel = pending.length ? `${pending.length} pendência(s) essencial(is)` : (quality.recommendedMissing.length ? 'Completo • há recomendações' : 'Completo');
  return `<div class="review-professional-layout v32-review">
    <aside class="review-overview-panel">
      <section class="review-summary-card"><p class="eyebrow">5. Revisão e finalização</p><h1>Conferência do BO</h1><div class="quality-status ${pending.length?'pending':'complete'}"><span>${pending.length?ICONS.warning:ICONS.check}</span><div><strong>${escapeHtml(qualityLabel)}</strong><small>${completed.length} de ${items.length} blocos conferidos</small></div></div>${quality.recommendedMissing.length?`<p class="recommended-note">${quality.recommendedMissing.length} informação(ões) recomendada(s) não preenchida(s). Elas não impedem a finalização.</p>`:''}</section>
      ${pending.length?`<section class="review-status-group pending-group"><div class="review-group-title"><span>${ICONS.warning}</span><div><strong>Pendências essenciais</strong><small>Toque para corrigir antes de enviar.</small></div></div>${renderReviewStatusList(pending,true)}</section>`:'<section class="review-ready-card">'+ICONS.success+'<div><strong>BO pronto para envio</strong><small>Todos os itens essenciais foram conferidos.</small></div></section>'}
    ...
    <div class="review-detail-panel">
      ...
      <div class="review-grid compact-review-grid">
        ${reviewSection('Ocorrência',0,`<dl class="definition-grid"><div><dt>Fato</dt><dd>${formatDateOnly(b.data)} às ${escapeHtml(b.hora)}</dd></div><div><dt>Solicitante</dt><dd>${escapeHtml(b.nomeEmissor)} • ${escapeHtml(b.matriculaEmissor)}</dd></div><div><dt>Local</dt><dd>${escapeHtml(b.local)} — ${escapeHtml(b.complementoLocal)}</dd></div><div><dt>Diretoria / área</dt><dd>${escapeHtml(directorate||'Não informada')}${b.setorArea?` • ${escapeHtml(b.setorArea)}`:''}</dd></div></dl>`)}
        ${reviewSection('Elementos relacionados',1,`<div class="review-mini-grid four-items"><div><strong>Envolvidos</strong><span>${r.people.filter(person=>person.tipo!=='Testemunha').length||'Nenhum'}</span></div><div><strong>Testemunhas</strong><span>${r.people.filter(person=>person.tipo==='Testemunha').length||'Nenhuma'}</span></div><div><strong>Veículos</strong><span>${r.vehicles.length||'Nenhum'}</span></div><div><strong>Materiais/cargas</strong><span>${r.materials.length||'Nenhum'}</span></div></div>`)}
        ${reviewSection('Apuração padronizada',2,`<dl class="definition-grid"><div style="grid-column:1/-1"><dt>Relato recebido</dt><dd>${escapeHtml(r.history.inicio||'Não informado')}</dd></div><div style="grid-column:1/-1"><dt>Constatação da Segurança</dt><dd>${escapeHtml(r.history.identificado||'Não informado')}</dd></div>${answers.map(item=>`<div><dt>${escapeHtml(item.label)}</dt><dd>${escapeHtml(item.value)}</dd></div>`).join('')}</dl>`)}
        ...
        ${reviewSection(`Evidências (${r.attachments.length})`,3,r.attachments.length?`<div class="entity-meta">${r.attachments.map(file=>`<span class="chip">${escapeHtml(file.name)}</span>`).join('')}</div>`:`<div class="entity-empty">${r.verification.attachments==='none'?`Evidência não registrada${r.templateData?.evidenceUnavailableReason?`: ${escapeHtml(r.templateData.evidenceUnavailableReason)}`:'.'}`:'Evidências ainda não verificadas.'}</div>`)}
        ${reviewSection('Relato consolidado',4,`<div class="final-report-preview">${escapeHtml(r.history.relato||'Relato ainda não gerado.').replace(/\n/g,'<br>')}</div><div class="about-actions"><button class="button secondary small" type="button" data-action="assistant-generate">${ICONS.sync} Atualizar relato</button></div>`)}
      </div>
...
function reviewSection(title, step, body) {
  return `<section class="review-section"><div class="review-head"><h3>${title}</h3><button class="button small secondary" type="button" data-review-edit="${step}">Editar seção</button></div><div class="review-body">${body}</div></section>`;
}
...
function renderBasicCorrection(focus) {
  ...
  let fields = '';
  if (['bo-date','bo-time','bo-ref','bo-ref-other'].includes(id)) {
    title = 'Data, hora e referência';
    fields = `<div class="field"><label class="required" for="bo-date">Data da ocorrência</label><input id="bo-date" type="date" value="${escapeHtml(b.data)}" data-path="basic.data" required><span class="field-error" data-error-for="bo-date"></span></div><div class="field"><label class="required" for="bo-time">Hora da ocorrência</label><input id="bo-time" type="time" value="${escapeHtml(b.hora)}" data-path="basic.hora" required><span class="field-error" data-error-for="bo-time"></span></div>${basicReferenceFields(b)}`;
  } else if (['bo-reg','bo-name','bo-email'].includes(id)) {
    title = 'Dados do solicitante';
    fields = basicRequesterFields(b);
    ...
    fields = `<div class="field"><label class="required" for="bo-date">Data da ocorrência</label><input id="bo-date" type="date" value="${escapeHtml(b.data)}" data-path="basic.data" required></div><div class="field"><label class="required" for="bo-time">Hora da ocorrência</label><input id="bo-time" type="time" value="${escapeHtml(b.hora)}" data-path="basic.hora" required></div>${basicReferenceFields(b)}${basicRequesterFields(b)}${basicLocationFields(b)}${basicDirectorateFields(b)}`;
  }
  return `<section class="form-card correction-card" data-correction-section="occurrence"><p class="eyebrow">Correção rápida</p><h1>${title}</h1><p>Altere somente os dados necessários e salve para retornar à revisão.</p><div class="form-grid">${fields}</div></section>`;
}
...
function renderReportCorrection() {
  const h = state.current.history;
  return `${renderAssistantCard(state.current)}<section class="form-card correction-card" data-correction-section="report"><p class="eyebrow">Correção rápida</p><h1>Relato consolidado</h1><p>Complete os fatos essenciais, gere o texto e revise antes de salvar.</p><div class="form-grid">
    <div class="field full"><label class="required" for="history-start">Como a ocorrência começou?</label><textarea id="history-start" data-path="history.inicio" required>${escapeHtml(h.inicio)}</textarea><span class="field-error" data-error-for="history-start"></span></div>
    <div class="field full"><label class="required" for="history-found">O que foi identificado ou constatado?</label><textarea id="history-found" data-path="history.identificado" required>${escapeHtml(h.identificado)}</textarea><span class="field-error" data-error-for="history-found"></span></div>
    <div class="field full"><label class="required" for="history-end">Como a situação terminou?</label><textarea id="history-end" data-path="history.desfecho" required>${escapeHtml(h.desfecho)}</textarea><span class="field-error" data-error-for="history-end"></span></div>
    <div class="field full"><label for="history-extra">Informação adicional</label><textarea id="history-extra" data-path="history.adicional">${escapeHtml(h.adicional)}</textarea></div>
    <div class="field full"><label class="required" for="history-report">Relato consolidado</label><textarea id="history-report" data-path="history.relato" data-manual-narrative="true" required>${escapeHtml(h.relato)}</textarea><span class="field-error" data-error-for="history-report"></span></div>
  </div><div class="correction-inline-action"><button class="button primary" type="button" data-action="assistant-generate">${ICONS.file} Gerar ou atualizar relato</button></div></section>`;
}
...
function renderFocusedCorrection(focus) {
  const configs = {
    ...
    people: () => relatedSection('people',{verify:'people',title:'Pessoas relacionadas',description:'Cadastre as pessoas identificadas ou confirme que não se aplica.',button:'Adicionar pessoa',question:'Há pessoa identificada?',noneLabel:'Não há pessoa identificada',empty:'Nenhuma pessoa cadastrada.',render:renderPersonItem,filter:person=>person.tipo!=='Testemunha',recommended:false}),
    witnesses: renderWitnessCorrection,
    vehicles: () => relatedSection('vehicles',{verify:'vehicles',title:'Veículos relacionados',description:'Cadastre placa, chassi, empresa e pessoa relacionada.',button:'Adicionar veículo',question:'Há veículo relacionado?',noneLabel:'Não há veículo relacionado',empty:'Nenhum veículo cadastrado.',render:renderVehicleItem,recommended:true}),
    materials: () => relatedSection('materials',{verify:'materials',title:'Materiais, peças e cargas',description:'Cadastre denominação, MVM/NF, desenho, quantidade e demais dados.',button:'Adicionar material',question:'Há material relacionado?',noneLabel:'Não há material relacionado',empty:'Nenhum material cadastrado.',render:renderMaterialItem,recommended:true}),
    providencias: renderProvidencesCorrection,
    report: renderReportCorrection,
    attachments: renderAttachmentsStep,
...
function bindStepSpecific() {
  app.querySelectorAll('[data-select-category]').forEach(button => button.addEventListener('click', async()=>{
    ...
    if (!category || state.current.basic.categoria === category) return;
    state.current.basic.categoria = category;
    state.current.basic.referencia = '';
    state.current.basic.referenciaOutra = '';
    state.current.templateData ||= {reference:'',requesterRole:'',answers:{}};
    ...
    state.current.assistant.stale = true;
    await saveCurrent(true,false);
    renderWizard();
    showNexoAction('Categoria selecionada. Escolha agora o tipo de boletim.','success','NEXO');
  }));
  app.querySelectorAll('[data-select-reference]').forEach(button => button.addEventListener('click', async()=>{
    const reference = normalizeReference(button.dataset.selectReference || '');
    if (!reference) return;
    const previous = normalizeReference(state.current.basic.referencia || '');
    ...
    await saveCurrent(true,false);
    renderWizard();
    showNexoAction(`Modelo “${reference}” aplicado. O fluxo foi adaptado.`, 'success', 'NEXO');
  }));
...
Informe uma justificativa curta:`) || '').trim();
  ...
  app.querySelectorAll('[data-review-edit]').forEach(button=>button.addEventListener('click',()=>{state.correctionFocus=null;state.currentStep=Number(button.dataset.reviewEdit);renderWizard();updateHeader();window.scrollTo(0,0);}));
  ...
  app.querySelectorAll('[data-action="assistant-generate"]').forEach(generate => generate.addEventListener('click', async () => {
    ...
    await saveCurrent(true, false);
    renderWizard();
    showToast('Relato e providências organizados pelo assistente.');
    await new Promise(resolve => requestAnimationFrame(resolve));
...
async function handleAttachments(event) {
  ...
  for(const file of files){
    ...
    addAudit(state.current, 'ADICIONAR ANEXO', `${prepared.name} • ${humanSize(prepared.size)}`);
    markAssistantStale(state.current);
  }
...
async function openReviewCorrection(item) {
...
async function handleStepAction(action) {
  ...
  if (action === 'next') {
    ...
    if (state.currentStep === 3) {
      ...
      state.current.assistant = {generatedAt:new Date().toISOString(),profile:assistantContext(state.current).profile,stale:false};
  ...
  if (action === 'finalize') {
    ...
    if (recommendedMissing.length) {
      const proceed = await openAppModal({
        kind:'warning',
        eyebrow:'Conferência de informações',
        title:'Há informações recomendadas não preenchidas',
        message:'Esses dados podem tornar o BO mais completo. Continue apenas quando a informação não estiver disponível ou não se aplicar.',
        details:`<ul>${recommendedMissing.slice(0,10).map(item=>`<li>${escapeHtml(item.label)} — ${escapeHtml(item.message)}</li>`).join('')}</ul>`,
        confirmText:'Continuar mesmo assim',
        cancelText:'Voltar e completar'
      });
      if (!proceed) {
        const first = recommendedMissing[0];
        state.currentStep = first.step;
        updateHeader();
        renderWizard();
        await new Promise(resolve => requestAnimationFrame(resolve));
    ...
    const confirmed = await openAppModal({
      ...
      details:'<ul><li>Confira relato e providências.</li><li>Confirme pessoas, veículos, materiais e anexos.</li><li>Não feche o aplicativo durante o envio.</li><li>O horário de término do atendimento será registrado automaticamente.</li></ul>',
...
function collectStepIssues(step, record = state.current) {
  ...
  if (step === 1) {
    ...
    const modes = templateFor(record.basic?.referencia).entities || {};
    if ((modes.people||'recommended') !== 'hidden') {
      if (!String(record.templateData?.requesterRole||'').trim()) add('requester-role','Informe a relação do solicitante com o fato.','Relação do solicitante','people');
      if (v.people === 'pending') add('','Confirme se existem outras pessoas diretamente envolvidas.','Verificação incompleta','people');
      if (v.people === 'has' && !(record.people||[]).some(p=>p.tipo!=='Testemunha')) add('','Foi indicado que existem pessoas envolvidas, mas nenhum cadastro foi incluído.','Pessoa não cadastrada','people');
      const involved = requesterCountsAsInvolved(record) || (record.people||[]).some(p=>p.tipo!=='Testemunha');
      if (modes.people === 'required' && !involved) add('','Este modelo exige a identificação de ao menos uma pessoa diretamente envolvida.','Informação essencial ausente','people');
    }
    if ((modes.witnesses||'recommended') !== 'hidden') {
      if (v.witnesses === 'pending') add('','Confirme se existem testemunhas identificadas.','Verificação incompleta','witnesses');
      if (v.witnesses === 'has' && !(record.people||[]).some(p=>p.tipo==='Testemunha')) add('','Foi indicado que existem testemunhas, mas nenhuma foi cadastrada.','Testemunha não cadastrada','witnesses');
    }
    if ((modes.vehicles||'recommended') !== 'hidden') {
      if (v.vehicles === 'pending') add('','Confirme se existe veículo relacionado.','Verificação incompleta','vehicles');
      if (v.vehicles === 'has' && !(record.vehicles||[]).length) add('','Foi indicado que existe veículo, mas nenhum foi cadastrado.','Veículo não cadastrado','vehicles');
      if (modes.vehicles === 'required' && !(record.vehicles||[]).length) add('','Este modelo exige o cadastro do veículo relacionado.','Informação essencial ausente','vehicles');
    }
    if ((modes.materials||'recommended') !== 'hidden') {
      if (v.materials === 'pending') add('','Confirme se existe material, peça, equipamento ou carga relacionado.','Verificação incompleta','materials');
      if (v.materials === 'has' && !(record.materials||[]).length) add('','Foi indicado que existe material relacionado, mas nenhum foi cadastrado.','Material não cadastrado','materials');
      if (modes.materials === 'required' && !(record.materials||[]).length) add('','Este modelo exige o cadastro do material, peça, equipamento ou carga.','Informação essencial ausente','materials');
    }
  }

  if (step === 2) {
    const h = record.history || {};
    if (!String(h.inicio||'').trim()) add('history-start','Registre como o fato foi informado à equipe.');
    if (!String(h.identificado||'').trim()) add('history-found','Registre o que a Segurança constatou no local.');
  ...
  if (step === 3) {
    ...
    if (record.verification.attachments === 'pending') add('','Confirme se existem fotos ou documentos.','Evidências não verificadas','attachments');
    if (record.verification.attachments === 'has' && !(record.attachments||[]).length) add('','Foi indicado que existe evidência, mas nenhum arquivo foi adicionado.','Anexo não incluído','attachments');
    if (templateFor(record.basic?.referencia).evidence === 'required' && record.verification.attachments === 'none' && !String(record.templateData?.evidenceUnavailableReason||'').trim()) add('evidence-unavailable-reason','Justifique por que não foi possível registrar a evidência.','Evidência essencial indisponível','attachments');
  }
...
function renderDetail() {
  ...
  <div class="review-grid">
    ${reviewSectionStatic('Ocorrência',`<dl class="definition-grid"><div><dt>Categoria</dt><dd>${escapeHtml(b.categoria||referenceCategory(b.referencia)||'Não informada')}</dd></div><div><dt>Referência</dt><dd>${escapeHtml(reference||'Não informada')}</dd></div><div><dt>Local</dt><dd>${escapeHtml(b.local)} — ${escapeHtml(b.complementoLocal)}</dd></div><div><dt>Diretoria / área</dt><dd>${escapeHtml(directorate||'Não informada')}${b.setorArea?` • ${escapeHtml(b.setorArea)}`:''}</dd></div><div><dt>Solicitante</dt><dd>${escapeHtml(b.nomeEmissor)} • ${escapeHtml(b.matriculaEmissor)}</dd></div><div><dt>Data/hora do fato</dt><dd>${formatDateOnly(b.data)} às ${escapeHtml(b.hora)}</dd></div><div><dt>Início do BO</dt><dd>${formatDateTime(r.operationalTiming?.startedAt||r.createdAt)}</dd></div><div><dt>Finalização</dt><dd>${formatDateTime(r.finalizedAt)}</dd></div><div><dt>Duração do atendimento</dt><dd>${escapeHtml(attendance.label)}</dd></div></dl>`)}
    ${reviewSectionStatic('Apuração padronizada',`<dl class="definition-grid"><div style="grid-column:1/-1"><dt>Relato recebido</dt><dd>${escapeHtml(r.history.inicio||'Não informado')}</dd></div><div style="grid-column:1/-1"><dt>Constatação da Segurança</dt><dd>${escapeHtml(r.history.identificado||'Não informado')}</dd></div>${templateAnswerSummary(r).map(item=>`<div><dt>${escapeHtml(item.label)}</dt><dd>${escapeHtml(item.value)}</dd></div>`).join('')}</dl>`)}
    ...
    ${reviewSectionStatic(`Evidências (${r.attachments.length})`, r.attachments.length ? `<div class="file-grid detail-file-grid">${r.attachments.map((file,index)=>renderFileItem(file,index)).join('')}</div>` : '<div class="entity-empty">Nenhuma evidência anexada.</div>')}
  ...
  app.querySelector('[data-action="qr-record"]').addEventListener('click', async()=>{const mod=await ensureAdvancedLoaded();mod?.showQr?.(state.current);});
  bindAttachmentPreviews();
...
function updateConnectivityUi() {
  ...
  if (offline) {
    ...
    offlineBannerText.textContent = `${pending.length} registro(s) aguardando. Os dados continuam salvos neste aparelho e serão enviados automaticamente quando a conexão retornar.`;
  } else if (conflicts) {
